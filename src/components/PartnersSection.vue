...
const clients = [
  ...
  { file: 'maersk-oil.jpg',             name: 'Maersk Oil (TotalEnergies)' },
  ...
  { file: 'king-institute.png',         name: 'Kazakh Institute of Oil & Gas (KING)' },
...
const partners = [
  ...
  { file: 'kape.png',                  name: 'KAPE' },
  { file: 'kazekoproekt.png',          name: 'KazEkoProekt' },
  { file: 'kirg-institute.png',        name: 'Kyrgyz Engineering Institute' },
  { file: 'kitng-institute.png',       name: 'KITNG Institute' },
